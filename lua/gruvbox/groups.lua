...
local function get_base_colors(colors, contrast)
  ...
  local base_colors = {
    ...
    subtle_brown = colors.dark_brown,
    subtle_green = colors.dark_green,
    subtle_red = colors.dark_red,
    subtle_yellow = colors.dark_yellow,
  }
  ...
  local light_colors = {
    ...
    neutral_purple = colors.neutral_purple,
    neutral_aqua = colors.neutral_aqua,
    subtle_brown = colors.light_brown,
    subtle_green = colors.light_green,
    subtle_red = colors.light_red,
    subtle_yellow = colors.light_yellow,
  }
  ...
  base_colors.dark_gray = colors.dark_gray
...
groups.setup = function()
  ...
  local groups = {
    ...
    GruvboxRedSign = { fg = colors.red, bg = nil, reverse = config.invert_signs },
    GruvboxGreenSign = { fg = colors.green, bg = nil, reverse = config.invert_signs },
    GruvboxYellowSign = { fg = colors.yellow, bg = nil, reverse = config.invert_signs },
    GruvboxBlueSign = { fg = colors.blue, bg = nil, reverse = config.invert_signs },
    GruvboxPurpleSign = { fg = colors.purple, bg = nil, reverse = config.invert_signs },
    GruvboxAquaSign = { fg = colors.aqua, bg = nil, reverse = config.invert_signs },
    GruvboxOrangeSign = { fg = colors.orange, bg = nil, reverse = config.invert_signs },
    ...
    CursorLineNr = { fg = colors.aqua, bg = colors.bg0 },
    NonText = { link = "GruvboxBg2" },
    SpecialKey = { link = "GruvboxFg4" },
    Visual = { bg = colors.bg3, reverse = config.invert_selection },
    VisualNOS = { link = "Visual" },
    Search = { fg = colors.light1, bg = colors.gray, reverse = config.inverse },
    IncSearch = { fg = colors.light1, bg = colors.orange, reverse = config.inverse },
    ...
    String = { fg = colors.aqua, italic = config.italic },
